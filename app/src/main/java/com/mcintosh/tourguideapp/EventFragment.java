...
public class EventFragment extends Fragment {
    ...
    private ArrayList<Attraction> getAttractionList() {
        ...
        attractionList.add(new Attraction("event", "Boston Celtics", "NBA Team based in Boston, " +
                "a" + " member of the Eastern Conference Atlantic Division and former home of the" +
                " great" + " Larry Bird.", R.drawable.celtics));
        attractionList.add(new Attraction("event", "Boston Bruins", "A professional ice hockey "
                + "team based in Boston. They are members of the Atlantic Division of the " +
                "Eastern" + " Conference of the National Hockey League. The team has been in " +
                "existence since " + "1924, and is the league's third-oldest team overall and the" +
                " oldest in the United" + " States.", R.drawable.bruins));
        attractionList.add(new Attraction("event", "New England Patriots", "Home of Tom Brady " +
                "amd" + " five time superbowl champs.", R.drawable.pats));
        attractionList.add(new Attraction("event", "Boston Opera House", "When you're completely " +
                "" + "sick of sports, check out a show at the Boston Opera House. Originally " +
                "built as " + "a movie palace, it opened on October 29, 1928 and was rededicated " +
                "in 1980 as a " + "home for the Opera Company of Boston.", R.drawable.opera));
